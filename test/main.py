...
#     }
# }
# INDICES_SETTINGS = [index_settings_standart_analyzer, index_settings_standart_analyzer_ngramms, index_settings_custom_analyzer, index_settings_custom_analyzer_ngramms]
#
